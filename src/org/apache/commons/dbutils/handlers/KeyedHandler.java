...
public class KeyedHandler<K> extends AbstractKeyedHandler<K, Map<String, Object>> {
     ...
     * into Objects.
     */
    protected final RowProcessor<Map<String,Object>> convert;
     ...
     */
    public KeyedHandler() {
        this(MapRowProcessor.ROW_PROCESSOR, 1, null);
    }
     ...
     */
    public KeyedHandler(RowProcessor<Map<String, Object>> convert) {
        this(convert, 1, null);
    }
    ...
    public KeyedHandler(int columnIndex) {
        this(MapRowProcessor.ROW_PROCESSOR, columnIndex, null);
    }
    ...
    public KeyedHandler(String columnName) {
        this(MapRowProcessor.ROW_PROCESSOR, 1, columnName);
    }
     ...
     * retrieved from the column with this name.
     */
    private KeyedHandler(RowProcessor<Map<String, Object>> convert, int columnIndex,
            String columnName) {
        super();
